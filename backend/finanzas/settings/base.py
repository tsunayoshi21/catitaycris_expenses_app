...
# BCrypt as secondary hasher for compatibility with existing bcrypt hashes from Flask app
PASSWORD_HASHERS = [
...
BANK_SENDERS = [s.strip().lower() for s in os.getenv('BANK_SENDERS', '').split(',') if s.strip()]
